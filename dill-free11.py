...
psb('\x1b[1;32mBANGLADESH DILL 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'FACEBOOK : facebook.com/dill.mohammad.20'

    print 'GITHUB     : github.com/DILL'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Dill-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[Dill-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
